...
namespace Petlance
{
    class OrderLayout : EntityLayout
    {
        ...
        public OrderLayout(Context context, Offer offer, OrderType orderType) : base(context)
        {
            this.offer = offer;
            Initialize();
        }
        private void Initialize()
        {
            ...
            Click += AdvertisementLayout_Click;
        }
        ...
        private void AdvertisementLayout_Click(object sender, EventArgs e)
        {
            if ((Context is PetlanceActivity) && (sender is OfferLayout))
            {
